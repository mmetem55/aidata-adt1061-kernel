...
#ifndef CONFIG_ELINK_SILEAD_LISTS_NAME
#define CONFIG_ELINK_SILEAD_LISTS_NAME ""
#endif
						   ...
						   const struct i2c_device_id *id)
{
	...
	if (CONFIG_ELINK_SILEAD_LISTS_NAME[0] != '\0')
		snprintf(data->fw_name, sizeof(data->fw_name), "%s",
				 CONFIG_ELINK_SILEAD_LISTS_NAME);
